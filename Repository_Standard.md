...
All code repositories must include a requirements.txt file, if applicable.
...
If no special libraries are used, the requirements.txt file will be empty and can be deleted.
